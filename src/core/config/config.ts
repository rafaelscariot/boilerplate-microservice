...
const REQUIRED_ENV_VARS = [
  ...
  //TODO: its only necessary if its in production environment 'STRING_CONNECTION',
];
...
export class ConfigKafka {
  ...
  static readonly STRING_CONNECTION = env.STRING_CONNECTION;
  static readonly FROM_BEGINNING: boolean =
    env.FROM_BEGINNING === 'true' ? true : false;
}
...
export const database = env.DB_URI;
